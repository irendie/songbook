...
% babel-czech's \uv looks up quote glyphs in OT1, which our fontspec-loaded
% CMU fonts don't provide in bold/medium, causing "undefined shape" warnings;
% redefine it to insert the Unicode quote characters directly instead.
\renewcommand{\uv}[1]{„#1“}
