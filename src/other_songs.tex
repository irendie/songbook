...
\beginverse
\nolyrics{\[Cm] \[Cm]}
\[Cm]V sedě anebo \[Gm]v leže, \[F]stojíc \[Fm]anebo jdouc\[Gm],
\[Cm]mezi námi \[Gm]věže, \[F]z naší lásky troud\[Gm],
hořet\[Eb] anebo \[B]hasit, \[Fm]splývat anebo plout[Gm],
\[Cm]zůstat anebo [Gm]zkusit se \[F]znovu \[Gm]nadechnout\[Cm].
\endverse
\beginchorus
...
\endchorus
\beginverse
\[Cm]Letět anebo \[Gm]viset, \[F]mlčet anebo řvát\[Gm],
\[Cm]myslet, zda má to \[Gm]cenu, \[F]jít se za to rvát\[Gm],
...
\[Cm]doufat, že naše \[Gm]láska \[F]není trilo\[Gm]bit,
